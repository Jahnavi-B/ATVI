...
def greet():
    ...
    conn.commit()
    conn.close()
    SR.speak("\nMyself Athvie. How may I help you?")
...
def mainframe():
    ...
    try:
        while(True):
            ...
            elif there_exists(['clear screen', 'clearscreen'], query):
                clearScreen()
                break
            ...
            #asking for name
                ...
                SR.speak("My name is Athvie and I'm here to serve you.")
            #How are you
            ...
            #play music
                ...
                music_dir='C:\\Users\\Jahnavi\\Music'
            ...
            #opening software applications
                ...
                os.startfile(r"C:\Program Files\Windows Media Player\wmplayer.exe")
                break
...
if __name__=="__main__":
        ...
        root.geometry("{}x{}+{}+{}".format(800,900,int(root.winfo_screenwidth()/2 - 800/2),int(root.winfo_screenheight()/2 - 900/2)))
        root.resizable(1,1)
        root.title("ATVI")
        root.iconbitmap('ATVI.ico')
        root.configure(bg='#2c4557')
        scrollable_text=scrolledtext.ScrolledText(root,state='disabled',height=108,width=62,relief='sunken',bd=5,wrap=tk.WORD,bg='#FFEEDD',fg='#800000')
        ...
        Speak_label=tk.Label(root,text="SPEAK:",fg="#6C007F",font='"Times New Roman" 12 ',borderwidth=0,bg='#9FFFED')
        Speak_label.place(x=250,y=680)
        """Setting up objects"""
        ...
        Listen_Button.place(x=333,y=651)
        myMenu=tk.Menu(root)
